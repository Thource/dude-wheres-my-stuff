...
public interface DudeWheresMyStuffConfig extends Config {
  ...
  @ConfigItem(
      ...
      position = 2,
      description =
          "When enabled, items from different storages will be combined into a single row in the"
              + " exported CSV file. This means that the CSV won't contain which item is in which"
              + " storage.")
  ...
  @ConfigItem(
      ...
      position = 101,
      description =
          "Google spreadsheet ID if you have an existing sheet. The target sheet must have been"
              + " created by the plugin. If you do not provide this, we will create one and"
              + " populate this field.")
  ...
  @ConfigItem(
      ...
      description =
          "Adds a tooltip when you hover items that tells you how many of those item you have"
              + " stored. \"Simple\" mode shows a sum, \"Detailed\" mode tells you where they are "
              + "stored.")
  ...
  @ConfigItem(
      ...
      description =
          "When enabled, deathpile/grave expiry will be based on account play time, this means"
              + " that if you play for 5 minutes on another client (like mobile) your"
              + " deathpile/grave timer will still be accurate.<br><br>Using this option requires"
              + " you to set your quest tab to the \"Character summary\" tab (brown star icon)"
              + " once per login. With this option enabled, an infobox will be displayed prompting"
              + " you to swap to the \"Character summary\" tab when the plugin doesn't know your"
              + " play time.<br><br>If the plugin doesn't know your play time at the time of your"
              + " death, the deathpile/grave will default to non cross-client tracking mode.",
      section = DEATHPILE_OPTIONS_SECTION,
      position = 101)
  ...
  @ConfigItem(
      ...
      description =
          "The minutes remaining on your oldest deathpile / grave before you start getting"
              + " alerted.",
      section = DEATHPILE_OPTIONS_SECTION,
      position = 108)
