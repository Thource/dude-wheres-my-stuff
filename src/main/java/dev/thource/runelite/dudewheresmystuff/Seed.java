...
public enum Seed {
  ...
  GOUT_TUBER(ItemID.GOUT_TUBER, "Gout tuber"),
  ...
  HAMMERSTONE(ItemID.HAMMERSTONE_SEED, "Hammerstone seed"),
  ASGARNIAN(ItemID.ASGARNIAN_SEED, "Asgarnian seed"),
  JUTE(ItemID.JUTE_SEED, "Jute seed"),
  YANILLIAN(ItemID.YANILLIAN_SEED, "Yanillian seed"),
  KRANDORIAN(ItemID.KRANDORIAN_SEED, "Krandorian seed"),
  WILDBLOOD(ItemID.WILDBLOOD_SEED, "Wildblood seed"),

  // Bush seeds
  REDBERRY(ItemID.REDBERRY_SEED, "Redberry seed"),
  CADAVABERRY(ItemID.CADAVABERRY_SEED, "Cadavaberry seed"),
  DWELLBERRY(ItemID.DWELLBERRY_SEED, "Dwellberry seed"),
  JANGERBERRY(ItemID.JANGERBERRY_SEED, "Jangerberry seed"),
  WHITEBERRY(ItemID.WHITEBERRY_SEED, "Whiteberry seed"),
  POISON_IVY(ItemID.POISON_IVY_SEED, "Poison ivy seed"),
  ...
  MAGIC(ItemID.MAGIC_SEED, "Magic seed"),
  ...
  PINEAPPLE(ItemID.PINEAPPLE_SEED, "Pineapple seed"),
  ...
  // Special seeds
  SEAWEED(ItemID.SEAWEED_SPORE, "Seaweed spore"),
  GRAPE(ItemID.GRAPE_SEED, "Grape seed"),
  MUSHROOM(ItemID.MUSHROOM_SPORE, "Mushroom spore"),
  ...
  CRYSTAL(ItemID.CRYSTAL_ACORN, "Crystal acorn"),
  SPIRIT(ItemID.SPIRIT_SEED, "Spirit seed"),
  CELASTRUS(ItemID.CELASTRUS_SEED, "Celastrus seed"),
