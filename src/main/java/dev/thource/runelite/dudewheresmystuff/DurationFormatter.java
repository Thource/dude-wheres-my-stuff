...
public class DurationFormatter {
  ...
  private static final List<Long> times = Arrays.asList(TimeUnit.DAYS.toMillis(365),
  ...
  private static final List<String> timesString = Arrays.asList("year", "month", "day", "hour",
      "minute", "second");
