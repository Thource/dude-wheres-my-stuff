...
public enum DeathStorageType implements StorageType {
    ...
    HYDRA("Alchemical Hydra", -1, false, "hydra", true, 13, 14, Region.BOSS_HYDRA),
    GUARDIANS("Grotesque Guardians", -1, false, "guardians", true, 3, 4, Region.BOSS_GROTESQUE_GUARDIANS),
    SEPULCHRE("Hallowed Sepulchre", -1, false, "sepulchre", true, -100, -100, Region.MG_HALLOWED_SEPULCHRE),
    HESPORI("Hespori", -1, false, "hespori", true, 15, 16, Region.BOSS_HESPORI),
    MIMIC("The Mimic", -1, false, "mimic", true, 17, 18, null),
    NEX("Nex", -1, false, "nex", true, 29, 30, Region.BOSS_NEX),
    NIGHTMARE("The Nightmare", -1, false, "nightmare", true, 25, 26, Region.BOSS_NIGHTMARE),
    PHOSANI("Phosani's Nightmare", -1, false, "phosani", true, 27, 28, Region.BOSS_NIGHTMARE),
    TOB("Theatre of Blood", -1, false, "tob", true, 11, 12, Region.RAIDS_THEATRE_OF_BLOOD),
    VOLCANIC_MINE("Volcanic Mine", -1, false, "volcanicmine", true, 1, 2, Region.MG_VOLCANIC_MINE),
    VORKATH("Vorkath", -1, false, "vorkath", true, 5, 6, Region.BOSS_VORKATH),
    ZULRAH("Zulrah", -1, false, "zulrah", true, -100, -100, Region.BOSS_ZULRAH),
