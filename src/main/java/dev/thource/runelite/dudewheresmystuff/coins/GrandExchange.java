...
public class GrandExchange extends CoinsStorage {
  ...
  private boolean updateFromGEWindow() {
    ...
    for (int i = 0; i < 8; i++) {
      ...
      if (!Objects.equals(offerType.getText(), "Buy")) {
        continue;
      }
      ...
      if (!Objects.equals(offerBar.getTextColor(), 0x8f0000)) {
        continue;
      }
      ...
      coinStack.setQuantity(
          coinStack.getQuantity() + NumberUtils.toInt(offerCoins.getText().replaceAll("\\D+", ""),
              0));
    }
