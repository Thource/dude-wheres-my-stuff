...
public enum PlayerOwnedHouseStorageType implements StorageType {
  ...
  ARMOUR_CASE(
      ...
      Arrays.asList(
          ...
          ItemID.XERIC_TOP,
          ItemID.XERIC_ROBE)),
  // Latest update: https://oldschool.runescape.wiki/w/Magic_wardrobe_space?oldid=15106929
  MAGIC_WARDROBE(
      "Magic Wardrobe",
      InventoryID.POH_COSTUMES,
      "magicWardrobe",
  ...
  // Latest update: https://oldschool.runescape.wiki/w/Toy_box_space?oldid=15130174
  TOY_BOX("Toy Box", InventoryID.POH_COSTUMES, "toyBox", Arrays.asList(
      ...
      ItemID.ANTIPANTIES,
      ItemID.HW15_GRAVEDIGGER_HAT,
      ItemID.HW15_GRAVEDIGGER_TOP,
      ItemID.HW15_GRAVEDIGGER_LEGS,
      ItemID.HW15_GRAVEDIGGER_GLOVES,
      ItemID.HW15_GRAVEDIGGER_BOOTS,
